...
export default function DashboardScreen() {
  ...
  const [balance, setBalance] = useState(458.0);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerTitle}>IoT Electric Meter</Text>
        </View>
      ...
      >
        ...
        <View style={styles.gaugeContainer}>
          ...
          <View style={styles.gaugeTextContainer}>
            ...
            <Text style={styles.gaugeLimit}>of 740 kWh</Text>
            <View style={styles.trendBadge}>
              <Text style={styles.trendText}>12% above avg</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.costContainer}>
          ...
          <Text style={styles.costValue}>
            1,245.50 <Text style={styles.currency}>EGP</Text>
          </Text>
        </View>
        ...
        <View style={styles.card}>
          <View>
            ...
            <Text style={styles.cardValue}>
              {balance.toFixed(2)} <Text style={styles.currency}>EGP</Text>
            </Text>
          </View>
          <TouchableOpacity activeOpacity={0.8} style={styles.topUpButton}>
        ...
        <View style={styles.grid}>
          <View style={[styles.gridItem]}>
            ...
            <Text style={styles.gridValue}>
              2.4 <Text style={styles.gridUnit}>kW</Text>
            </Text>
          </View>
          <View style={[styles.gridItem]}>
            ...
            <Text style={styles.gridValue}>
              12 <Text style={styles.gridUnit}>days left</Text>
            </Text>
          </View>
        </View>
      ...
      <View style={styles.navBar}>
        <TouchableOpacity style={styles.navItem}>
          ...
          <Text style={styles.activeNavText}>DASH</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
